  ...
  try {
    ...
    const result = await query(`
      INSERT INTO clients (
        ...
        uses_car, car_method, uses_home_office, uses_mobile, mobile_business_percent, uses_internet,
    ...
    `, [
      ...
      clientData.uses_car || 'N',
      clientData.car_method || null,
      clientData.uses_home_office || 'N',
      clientData.uses_mobile || 'N',
      clientData.mobile_business_percent || null,
      clientData.uses_internet || 'N',
